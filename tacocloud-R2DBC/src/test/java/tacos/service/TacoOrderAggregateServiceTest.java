...
class TacoOrderAggregateServiceTest {
    ...
    TacoOrderAggregateService tacoOrderAggregateService;
    @BeforeEach
    public void setUp() {
        this.tacoOrderAggregateService = new TacoOrderAggregateService(tacoRepository, orderRepository);
    }
    @Test
    void shouldSaveAndFetchOrders() {
        ...
        StepVerifier.create(tacoOrderAggregateService.save(newOrder))
                .assertNext(this::assertOrder)
                .verifyComplete();
        StepVerifier.create(tacoOrderAggregateService.findById(1L))
                .assertNext(this::assertOrder)
                .verifyComplete();
    }
